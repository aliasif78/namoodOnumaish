const ContactUs = () => {
    return (
        <div className="flex flex-col w-full justify-center items-center mt-[1.25rem] gap-[3rem]">
            ...
            <div className="flex flex-row gap-[2rem] w-[70%] h-full justify-around">
                <div className="card flex flex-col justify-between rounded-2xl border-t-8 border-pink-400 bg-white shadow-2xl h-[18rem] w-[30%] p-[2rem] mt-[1.5rem]">
                    <div className="flex flex-col gap-[1rem]">
                        <span className="text-xl font-semibold">Instagram</span>
                        <p className="text-sm text-neutral-500">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Pariatur consectetur asperiores harum laborum expedita voluptatum?</p>
                    </div>
                ...
                <div className="card flex flex-col justify-between rounded-2xl border-t-8 border-green-400 bg-white shadow-2xl h-[21rem] w-[30%] p-[2rem]">
                    <div className="flex flex-col gap-[1rem]">
                ...
                <div className="card flex flex-col justify-between rounded-2xl border-t-8 border-red-400 bg-white shadow-2xl h-[18rem] w-[30%] p-[2rem] mt-[1.5rem]">
                    <div className="flex flex-col gap-[1rem]">
            ...
            <div className="flex flex-row gap-[2rem] w-[50%] h-full justify-around">
                <div className="card flex flex-col justify-between rounded-2xl border-t-8 border-blue-600 bg-white shadow-2xl h-[18rem] w-[43%] p-[2rem] mt-[1.5rem]">
                    <div className="flex flex-col gap-[1rem]">
                ...
                <div className="card flex flex-col justify-between rounded-2xl border-t-8 border-orange-400 bg-white shadow-2xl h-[18rem] w-[43%] p-[2rem] mt-[1.5rem]">
                    <div className="flex flex-col gap-[1rem]">
