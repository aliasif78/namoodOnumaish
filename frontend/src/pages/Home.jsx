    ...
    return (
        <>
            <div className="h-screen -mt-3">
                <div className="h-[70%] bg-[#6B7C65]">
                    <div className="flex flex-col gap-5 text-white h-full justify-end pl-[5rem] pb-[3rem]">
                        <h1 className='text-4xl lg:text-5xl font-bold w-[90%] lg:w-[40%] xl:w-[30%]'>Furniture That Everyone Loves</h1>

                        <p className='w-[90%] lg:w-[30%]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae explicabo quis ullam aspernatur, commodi rem expedita, incidunt nulla quia, earum est.</p>
                    ...
                    <div className="hidden lg:flex flex-row justify-end mr-[5rem]">
                        <img src="https://media-public.canva.com/_AvzM/MAEuIl_AvzM/1/tl.png" alt="img" className='w-[25rem] xl:w-[30rem] h-[15rem] -mt-[10rem]' />
            ...
            <div className="w-full h-fit flex-col justify-center items-center text-center pt-[3rem] bg-neutral-300">
                <h1 className="w-full h-fit flex justify-center text-3xl sm:text-5xl">Featured Products</h1>

                <div className="flex flex-col sm:flex-row justify-center px-[5rem] py-[3rem] gap-[3rem]">
                    ...
                    <div className="card hidden lg:flex flex-col w-fit h-fit">
            ...
            <div className="flex flex-col lg:flex-row w-full h-fit bg-neutral-900 text-white p-[4rem] my-[7rem] gap-[2rem]">
                <div className='flex flex-col gap-[2rem] lg:w-[60%] justify-center'>
                    <h1 className='text-3xl lg:text-5xl'>Wall-to-Wall Carpets</h1>
                    <p className='w-[75%] text-sm lg:text-base'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Similique omnis numquam dolorum quam deleniti placeat quidem culpa, quo deserunt cumque sint, iusto qui ipsa architecto minima, impedit ipsam in delectus.</p>
                ...
                <img src="https://www.vsurfaces.com/cdn/shop/files/Bedroom-Wall-To-Wall-Carpets.jpg?v=1684305323&width=900" alt="img" className='h-[20rem] sm:h-[30rem] lg:w-[40%]' />
            </div>

            <div className="w-full h-fit flex-col justify-center items-center text-center pt-[3rem] bg-neutral-300">
                <h1 className="w-full h-fit flex justify-center text-3xl sm:text-5xl">Explore Categories</h1>
